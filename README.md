...
5. 下拉并展开 NotiAsk 的常驻通知：点“提问”可直接输入问题；点“截屏搜索”可截取当前屏幕，截屏后还能再补充问题再发给 AI。回答通知可展开阅读并继续追问。
...
- 截屏提问走系统屏幕共享授权（MediaProjection）。截屏后可在预览页补充问题；不填则按默认提示让模型解读截图。需要当前默认模型支持视觉。
